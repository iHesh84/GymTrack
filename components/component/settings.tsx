 ...
 * @see https://v0.dev/t/OWbmMU8U5ta
 */
  ...
  return (
    <main className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      <header className="w-full p-4 bg-white dark:bg-gray-800 shadow-md fixed top-0">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 text-center">Settings</h1>
      </header>
        ...
        <Link href="#">
          <Card className="flex flex-row items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md w-full mb-4">
            <div className="flex flex-row items-center">
              ...
              <CardTitle className="text-gray-800 dark:text-gray-200">Profile</CardTitle>
            </div>
        ...
        <Link href="#">
          <Card className="flex flex-row items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md w-full mb-4">
            <div className="flex flex-row items-center">
              ...
              <CardTitle className="text-gray-800 dark:text-gray-200">Privacy</CardTitle>
            </div>
            <ArrowRightIcon className="h-6 w-6 text-gray-800 dark:text-gray-200" />
          </Card>
        </Link>
        <Link href="#">
          <Card className="flex flex-row items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md w-full mb-4">
            <div className="flex flex-row items-center">
              ...
              <CardTitle className="text-gray-800 dark:text-gray-200">Dark Mode</CardTitle>
            </div>
            <ArrowRightIcon className="h-6 w-6 text-gray-800 dark:text-gray-200" />
          </Card>
        </Link>
